...
void readAPuzzle(int length, int grid[][length]);
bool search(int length, int grid[][length]);
int getFreeCellList(int length, int grid[][length], int freeCellList[][2]);
void printGrid(int length, int grid[][length]);
bool isValid(int i, int j, int length, int grid[][length]);
bool isValid(int length, int grid[][length]);
...
int getFreeCellList(int length, int grid[][9], int freeCellList[][2])
{
...
bool isValid(int i, int j, int length, int grid[][length])
{
  ...
  for (int row = (i / sqrt(length) * sqrt(length); row < (i / sqrt(length)) * sqrt(length) + sqrt(length); row++)
    for (int col = (j / sqrt(length)) * sqrt(length); col < (j / sqrt(length)) * sqrt(length) + sqrt(length); col++)
